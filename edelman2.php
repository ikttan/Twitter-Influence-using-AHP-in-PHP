...
<link rel="stylesheet" href="edelmanstyle2.css" type="text/css" media="all">
<form action = "edelman2.php" method = "post">
...
function printnames(&$settings,&$shortlist,&$usercounts,&$edelman)
{
	...
	for ($i=0;$i<$usercounts;$i++)
	{
		...
		//echo "<br>\n<div class = 'score'><font size=10>User Influence = $finalscore </font></div><br>";

		echo "<tr><th class = 'firstcol'>User Influence</th><th class = 'secondcol'>$finalscore</th></tr>";
		echo "</table>";

		array_push($edelman, $finalscore);
	}
